...
import com.edu.greenwich.managementsystem.security.jwt.JwtUtils;
import com.edu.greenwich.managementsystem.security.payload.request.LoginRequest;
import com.edu.greenwich.managementsystem.security.payload.request.SignupRequest;
import com.edu.greenwich.managementsystem.security.payload.response.MessageResponse;
import com.edu.greenwich.managementsystem.security.payload.response.UserInfoResponse;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "dept":
                        Role modRole = roleRepository.findByName(ERole.ROLE_DEPT_QA)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
